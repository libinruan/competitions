...
# Pclass is converete to str
# all_df.Pclass = all_df.Pclass.astype(str) # not help

# TECH deal with high cardinality categorical features.
label_cols = ['Name', 'Ticket']
onehot_cols = ['Pclass', 'Sex', 'Cabin', 'Embarked']
numerical_cols = ['Age', 'SibSp', 'Parch', 'Fare', 'Survived', 'FamilySize', 'FC1_pt', 'FC2_pt', 'FC3_pt']
